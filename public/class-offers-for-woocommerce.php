        ...
        if ($custom_tab_options_offers['enabled'] == 'yes' && $is_display_offer_button && $is_instock && $custom_tab_options_offers['on_exit'] != 'yes') {
            ...
            if ($req_login) {
                ...
                if ($is_archive) {
                    ...
                    $button = '<a href="' . $redirect_url . '"><button type="button" id="offers-for-woocommerce-make-offer-button-id-' . $post->ID . '" class="offers-for-woocommerce-make-offer-button-single-product ' . $button_class . '  ' . $lightbox_class . ' button alt wp-element-button ' . $btn_position_class . '" style="' . $custom_styles_override . '">' . $button_title . '</button></a>';
                }
            } else {
                if ($is_archive) {
                    ...
                    $button = '<button type="button" id="offers-for-woocommerce-make-offer-button-id-' . $post->ID . '" class="offers-for-woocommerce-make-offer-button-single-product ' . $button_class . ' ' . $lightbox_class . ' button alt wp-element-button ' . $btn_position_class . '" style="' . $custom_styles_override . '">' . $button_title . '</button>';
                }
            }
