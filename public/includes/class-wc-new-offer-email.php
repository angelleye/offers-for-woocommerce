...
class WC_New_Offer_Email extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title = __('New offer', 'offers-for-woocommerce');

        // this is the description in WooCommerce email settings
        $this->description = __('New Offer Notification emails are sent to the admin when customer submits offer', 'offers-for-woocommerce');

        // these are the default heading and subject lines that can be overridden using the settings
        $this->heading = __('New Offer', 'offers-for-woocommerce');
        $this->subject = __('[{site_title}] New Offer ({offer_number}) - {offer_date}', 'offers-for-woocommerce');
