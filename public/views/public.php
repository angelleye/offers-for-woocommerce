...
<?php
$offer_single_use = isset( $parent_offer_id ) ? get_post_meta($parent_offer_id,'_offer_single_use_purchase', true) : false;
if( !empty( $offer_single_use ) ) {
    ?>
    <div id="tab_custom_ofwc_offer_single_use" class="tab_custom_ofwc_offer_single_use">
        <ul class="woocommerce-error aeofwc-woocommerce-error">
            <li><strong><?php echo __('Error:', 'offers-for-woocommerce');?>&nbsp;</strong><?php echo apply_filters('aeofwc_offer_error_message',__('This accepted offer price is no longer valid.  Please submit a new offer.', 'offers-for-woocommerce')); ?></li>
        </ul>
    </div>
    <?php
}
