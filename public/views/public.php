...
<div id="tab_custom_ofwc_offer_tab_inner" class="tab_custom_ofwc_offer_tab_inner_content">
    <fieldset>
        ...
        <form id="woocommerce-make-offer-form" name="woocommerce-make-offer-form" method="POST">
            ...
            <div class="woocommerce-make-offer-form-section">
                ...
                <br /><input type="text" id="offer-name" name="offer_name" required="required" />
            </div>
            <div class="woocommerce-make-offer-form-section">
                <label for="woocommerce-make-offer-form-email">Your Email Address</label>
                <br /><input type="email" name="offer_email" id="woocommerce-make-offer-form-email" required="required" />
            </div>
            <div class="woocommerce-make-offer-form-section">
                <label for="offer-notes">Offer Notes (optional)</label>
                <br /><textarea name="offer_notes" id="offer-notes" /></textarea>
            </div>            
