...
<?php do_action( 'woocommerce_email_header', $email_heading ); ?>
    ...
    <p>To make a counter offer use the following link: <a style="background:#EFEFEF; color:#161616; padding:8px 15px; margin:10px; border:1px solid #CCCCCC; text-decoration:none; " href="<?php echo $offer_args['product_url'].'?aewcobtn=1&offer-pid='.$offer_args['offer_id']. '&offer-uid=' .$offer_args['offer_uid']; ?>"><span style="border-bottom:1px dotted #666; "><?php echo __( 'Click to Counter', 'offers-for-woocommerce' ); ?></span></a>
    </p>
