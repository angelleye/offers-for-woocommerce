...
<?php if(isset($offer_args['final_offer']) && $offer_args['final_offer'] == '1') {
    ...
    <br><br><p style="font-size: 16px;text-align: center;font-family: inherit;"><?php _e('To make a counter offer use the following link:', 'offers-for-woocommerce'); ?></p>
    ...
    <tr>
        ...
        if( isset($offer_args['product_shipping_cost']) && $offer_args['product_shipping_cost'] != '0.00' && !empty($offer_args['product_shipping_cost'])) {
          ...
          ?>
            ...
            <td style="border-bottom: 1px solid #ddd; text-align:center"><?php echo get_woocommerce_currency_symbol() . ' ' . number_format( $offer_args['product_shipping_cost'],wc_get_price_decimals(), wc_get_price_decimal_separator(),wc_get_price_thousand_separator()); ?></td>
           <?php 
        }
        ?>
    </tr>
    <tr>
        ...
        if( isset($offer_args['product_shipping_cost']) && $offer_args['product_shipping_cost'] != '0.00' && !empty($offer_args['product_shipping_cost'])) {
          ?>
            ...
            <td style="border-bottom: 1px solid #ddd; text-align:center"><?php echo get_woocommerce_currency_symbol() . ' ' . number_format( $product_total, wc_get_price_decimals(), wc_get_price_decimal_separator(),wc_get_price_thousand_separator()); ?></td>
           <?php 
        }
        ?>
    </tr>
