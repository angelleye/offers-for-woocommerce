...
if ( $order->has_status( 'pending' ) )
    ...
    echo sprintf( __( 'We have accepted your offer on %s. To pay for this order please use the following link: %s', 'woocommerce' ), get_bloginfo( 'name' ), $order->get_checkout_payment_url() ) . "\n\n";
