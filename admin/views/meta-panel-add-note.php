...
echo '<div class="woocommerce-offer-edit-addnote-btn-wrap">';
    echo '<div class="private-note-checkbox-wrap"><input type="checkbox" name="note-admin-only" id="angelleye-woocommerce-offers-ajax-addnote-admin-only" autocomplete="off">Private Note</div>';
